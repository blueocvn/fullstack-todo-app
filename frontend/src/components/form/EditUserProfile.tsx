...
const EditUserProfile: React.FC = () => {
  ...
  return (
    <Card className="flex-1 max-w-4xl m-20">
      <form onSubmit={handleSubmit}>
        ...
        <div>
          ...
          <TextInput id="name" name="name" type="text" value={userEdited.name} onChange={handleChange} required />
        </div>
        <div>
          <div className="block mb-4">
            <Label htmlFor="dob" value="Ngày sinh" />
          </div>
          <TextInput id="dob" name="dob" type="date" value={userEdited.dob} onChange={handleChange} />
        </div>
        <div>
          <div className="block mb-2">
        ...
        <div>
          ...
          <TextInput id="phone" name="phone" type="text" value={userEdited.phone} onChange={handleChange} required />
        </div>
        <div>
          <div className="block mb-2">
